...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Апр 12 2020 г., 15:31
...
(3, 'Номер «Полулюкс» с 1 кроватью', './assets/img/3.jpg', './assets/img/min/3.jpg', 'Шкаф, 2-спальная кровать, Комод, Диван, Телевизор', '2500 ₽/сутки'),
...
--
ALTER TABLE `baskets`
  MODIFY `basket_id` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=406;
